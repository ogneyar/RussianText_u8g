...
void M(uint8_t x, uint8_t y) { 
    ...
    // третья строка
    u8g.drawPixel(x-1,y+2); // нулевой столбец
    ...
    // четвёртая строка
    u8g.drawPixel(x-1,y+3); // нулевой столбец
    ...
    // пятая строка
    u8g.drawPixel(x-1,y+4); // нулевой столбец
    ...
    // шестая строка
    u8g.drawPixel(x-1,y+5); // нулевой столбец
    ...
    // седьмая строка
    u8g.drawPixel(x-1,y+6); // нулевой столбец
